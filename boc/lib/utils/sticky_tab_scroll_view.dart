import 'package:boc/utils/screen_util.dart';
import 'package:boc/utils/sticky_widget.dart';
...
class TabStyle {
  ...
  final double tabTextIndicatorSpacing; // 文字和指示器之间的间距
  ...
  const TabStyle({
    ...
    this.tabTextIndicatorSpacing = 4, // 默认间距为4
  });
}
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: widget.tabStyle.tabTextIndicatorSpacing.h),
                      // 选中状态的下划线
                      Container(
