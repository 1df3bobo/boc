          ...
          Row(
            children: [
              ...
              AbcButton(
                ...
                onTap: () {
                  SmartDialog.dismiss();
                  state.szData.beginTime = state.beginTime;
                  state.szData.endTime = state.endTime;
        ...
        child: Row(
          ...
          children: [
            ...
            Row(
              children: [
                BaseText(
                  text: state.timeMTitle == '' ? '请选择' : state.timeMTitle,
                  color: Color(0xff666666),
                ),
                Icon(
                  Icons.navigate_next,
          ...
          SmartDialog.show(
            ...
            builder: (context) {
              return _pickTime(
                  ...
                  time: state.beginTime,
                  onConfirm: (){
                    state.timeMTitle = state.temTimeMTitle1;
                    setState(() {});
                  },
                  onCancel: (){
                    state.temTimeMTitle1 = state.timeMTitle;
                  },
                  showDya: false,
                  onDateTimeChanged: (date) {
                    state.selectTime = '';
                    state.showSelectTime = false;
                    state.temTimeMTitle1 = DateFormat("yyyy年MM月").format(date);
                    state.timeYTitle = '';
        ...
        child: Row(
          ...
          children: [
            ...
            Row(
              children: [
                BaseText(
                  text: state.timeYTitle == '' ? '请选择' : state.timeYTitle,
                  color: Color(0xff666666),
                ),
                Icon(
                  Icons.navigate_next,
        ...
        SmartDialog.show(
          ...
          builder: (context) {
            return _pickTime(
                ...
                showMonth: false,
                onConfirm: (){
                  state.timeYTitle = state.temTimeYTitle1;
                  setState(() {});
                },
                onCancel: (){
                  state.temTimeYTitle1 = state.timeYTitle;
                },
                onDateTimeChanged: (date) {
                  state.selectTime = '';
                  state.showSelectTime = false;
                  state.temTimeYTitle1 = DateFormat("yyyy年").format(date);
                  state.timeMTitle = '';
                  String currentMonth = DateFormat('yyyy-MM').format(date);
                  var result1 =
                      DateUtils1.getFormattedFirstAndLastDay(currentMonth);
